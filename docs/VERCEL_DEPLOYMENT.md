...
API variables, without values: `RESTEC_ENV`, `RESTEC_REPOSITORY_DRIVER`, `RESTEC_PUBLIC_BASE_URL`, `RESTEC_PAYMENT_SESSIONS_ENABLED`, `RESTEC_PAYMENT_SESSION_TTL_SECONDS`, `RESTEC_CHECKOUT_PUBLIC_BASE_URL`, `RESTEC_ALLOWED_PAYMENT_CHECKOUT_HOSTS`, `RESTEC_PAYMENT_SESSION_RETURN_POLL_SECONDS`, `RESTEC_DATABASE_URL`, `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `PAELY_PRIVATE_BASE_URL`, `PAELY_SERVICE_ID`, `PAELY_PRIVATE_BEARER_TOKEN`, `PAELY_PRIVATE_SIGNING_SECRET`, `PAELY_EVENT_SIGNING_SECRET`, `PAELY_EVENT_SERVICE_ID`, `RESTEC_API_KEY_HASH_SECRET`, `RESTEC_SECRET_ENCRYPTION_KEY`, `RESTEC_WEBHOOK_MASTER_KEY`, `RESTEC_TIMESTAMP_TOLERANCE_SECONDS`, `RESTEC_PRIVATE_REQUEST_TIMEOUT_MS`, `RESTEC_POS_DELIVERY_TIMEOUT_MS`, `RESTEC_MAX_DELIVERY_ATTEMPTS`, `RESTEC_DISPATCH_BATCH_SIZE`, `RESTEC_INTERNAL_JOB_TOKEN`, `RESTEC_STRICT_RATE_LIMITING`, `RESTEC_SHARED_RATE_LIMITER_URL`, `RESTEC_SHARED_RATE_LIMITER_TOKEN`, and `CRON_SECRET`.

Production must keep `RESTEC_PAYMENT_SESSIONS_ENABLED=false` until real sandbox certification and security review pass. Do not copy sandbox hosted-checkout allowlists or secrets into production.
